...
# int() and float() type coercion functions (checks if value can be converted to specified type). Otherwise it could easily stored as
    ...
    'relation_nodes' : {
        ...
        'schema': {
            ...
            'schema': {
                ...
                'member_role': {'required': True, 'type': 'string'},
